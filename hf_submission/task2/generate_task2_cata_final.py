...
TASK1_CATA_DIR = PROJECT_ROOT / "hf_submission" / "task1_cata"

for path in (PROJECT_ROOT, TASK1_CATA_DIR):
...
def main():
    ...
    parser.add_argument("--checkpoint", default=str(PROJECT_ROOT / "outputs" / "qwen3b_curriculum_topo_adapter_test_finetune_lr5e6_reset" / "checkpoints" / "last.pt"))
