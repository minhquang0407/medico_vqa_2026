...
class TopologicalExtractor:
    ...
    def _extract_global_features(self, topo_mask, topo_features):
        ...
        if mask_sum <= 1e-8 or np.isnan(mask_sum):
            ...
            topo_concentration = np.nan_to_num(topo_concentration, nan=0.0)
    ...
    def _normalize(self, array):
        ...
        res = (array - min_val) / (max_val - min_val)
        return np.nan_to_num(res, nan=0.0, posinf=0.0, neginf=0.0)